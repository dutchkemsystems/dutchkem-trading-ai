...
SYMBOLS = [
    ...
    {"name": "EURAUD", "description": "Euro vs Australian Dollar", "category": "MINOR", "base_currency": "EUR", "quote_currency": "AUD", "pip_size": "0.0001", "spread": "2.0", "contract_size": "100000"},
    ...
    {"name": "GBPCAD", "description": "British Pound vs Canadian Dollar", "category": "MINOR", "base_currency": "GBP", "quote_currency": "CAD", "pip_size": "0.0001", "spread": "2.5", "contract_size": "100000"},
    # ── Exotics (4) ─────────────────────────────────────────────────
    ...
    {"name": "USDCNH", "description": "US Dollar vs Chinese Yuan", "category": "EXOTIC", "base_currency": "USD", "quote_currency": "CNH", "pip_size": "0.0001", "spread": "10.0", "contract_size": "100000"},
    # ── Metals (3) ──────────────────────────────────────────────────
    ...
    {"name": "ETHUSD", "description": "Ethereum vs US Dollar", "category": "CRYPTO", "base_currency": "ETH", "quote_currency": "USD", "pip_size": "0.01", "spread": "10.0", "contract_size": "1"},
    {"name": "SOLUSD", "description": "Solana vs US Dollar", "category": "CRYPTO", "base_currency": "SOL", "quote_currency": "USD", "pip_size": "0.01", "spread": "5.0", "contract_size": "1"},
    # ── Indices (4) ─────────────────────────────────────────────────
    ...
    # ── African Exotics (extras, not in MarketScanner) ───────────────
