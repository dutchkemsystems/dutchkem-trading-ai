...
from app.api.deps import get_current_admin, DbSession, get_db
...
async def get_client_metrics(
    ...
    for client in clients:
        ...
        credits_spent = spend_result.scalar() or 0.0
