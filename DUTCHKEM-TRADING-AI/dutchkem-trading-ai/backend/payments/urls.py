...
urlpatterns = [
    ...
    path("withdraw/<uuid:transaction_id>/status/", views.WithdrawalStatusView.as_view(), name="withdrawal_status"),
    path("balance/", views.UserBalanceView.as_view(), name="user_balance"),
